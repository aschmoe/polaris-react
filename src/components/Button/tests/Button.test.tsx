...
describe('<Button />', () => {
  ...
  describe('disabled', () => {
    ...
    it('disable with a url renders <a> without a href (as <a disabled> is invalid HTML)>', () => {
      const button = shallowWithAppProvider(
  ...
  describe('loading', () => {
    ...
    it('loading with a url renders <a> without a href (as <a disabled> is invalid HTML)', () => {
      const button = shallowWithAppProvider(
